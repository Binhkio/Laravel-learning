...
const NavBar = (data) => {
    ...
    const selectColor = 'bg-gradient-to-b from-[#7928ca] to-[#ff0080]';
    ...
    return (
        <div className="pt-2 mx-12">
            <nav className=" grid grid-cols-4 text-fuchsia-300 font-bold border-2 border-[#ff0080] rounded-3xl backdrop-blur-md shadow-lg shadow-[#ff0080]">
                <Link to="/home">
                    <div className={`p-8 text-3xl font-semibold text-bold rounded-3xl hover:text-slate-100 text-center hover:bg-gradient-to-b hover:from-[#7928ca] hover:to-[#ff0080] ${data.curPage===1?selectColor:''}`}
                        >Home</div>
                </Link>

                <Link to="/restaurant">
                    <div className={`p-8 text-3xl font-semibold text-bold rounded-3xl hover:text-slate-100 text-center hover:bg-gradient-to-b hover:from-[#7928ca] hover:to-[#ff0080] ${data.curPage===2?selectColor:''}`}
                        >My Restaurants</div>
                </Link>

                <Link to="/create">
                    <div className={`p-8 text-3xl font-semibold text-bold rounded-3xl hover:text-slate-100 text-center hover:bg-gradient-to-b hover:from-[#7928ca] hover:to-[#ff0080] ${data.curPage===3?selectColor:''}`}
                        >Create new</div>
                </Link>

                <button className="p-8 text-3xl font-semibold text-bold rounded-3xl hover:text-slate-100 text-center hover:bg-gradient-to-b hover:from-[#7928ca] hover:to-[#ff0080]"
