        ...
        <div className="text-cyan-500 border-2 border-cyan-600 rounded-3xl backdrop-blur-md shadow-lg shadow-cyan-500">
            <form className="m-16 flex flex-col gap-6 ">
                ...
                <div className="mt-4">
                    ...
                    <input className="rounded-lg text-lg pl-4 py-1 border-2 border-cyan-500/100" type="text" name="username" value={loginForm.username} onChange={ (e) => {setLoginForm({...loginForm, username:e.target.value})} } placeholder="Username..." />
                </div>
                <div>
                    <p className="text-2xl font-bold p-2 tracking-wide">Password</p>
                    <input className="rounded-lg text-lg pl-4 py-1 border-2 border-cyan-500/100" type="password" name="password" value={loginForm.password} onChange={ (e) => {setLoginForm({...loginForm, password:e.target.value})}} placeholder="Password..." />
                </div>
                <div>
