...
function App() {
    return (
        <div className="flex justify-center h-screen w-screen items-center bg-cover  bg-[url('https://www.teahub.io/photos/full/13-135684_gallery-nice-wallpaper-hd-nice-wallpaper-hd-for.jpg')]">
            <Routes>
